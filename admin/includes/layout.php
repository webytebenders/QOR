        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-group">
                    ...
                    <a href="waitlist" class="nav-item <?= $activePage === 'waitlist' ? 'active' : '' ?>">
                    ...
                    <a href="posts" class="nav-item <?= $activePage === 'blog' ? 'active' : '' ?>">
                    ...
                    <a href="newsletter" class="nav-item <?= $activePage === 'newsletter' ? 'active' : '' ?>">
                    ...
                    <a href="automations" class="nav-item <?= $activePage === 'automations' ? 'active' : '' ?>">
                    ...
                    <a href="email" class="nav-item <?= $activePage === 'email' ? 'active' : '' ?>">
                ...
                <div class="nav-group">
                    ...
                    <a href="seo" class="nav-item <?= $activePage === 'seo' ? 'active' : '' ?>">
                    ...
                    <a href="chatbot" class="nav-item <?= $activePage === 'chatbot' ? 'active' : '' ?>">
                    ...
                    <a href="media" class="nav-item <?= $activePage === 'media' ? 'active' : '' ?>">
                ...
                <div class="nav-group">
                    ...
                    <a href="activity" class="nav-item <?= $activePage === 'activity' ? 'active' : '' ?>">
        ...
        <main class="main-content">
            <header class="topbar">
                ...
                <div class="topbar-actions">
                    <a href="/" target="_blank" class="topbar-btn" title="View Site">
